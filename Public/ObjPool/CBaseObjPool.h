#ifndef CBASEOBJPOOL_H
#define CBASEOBJPOOL_H
#include<stdlib.h>
#include<assert.h>
#include<mutex>
...
public:
    ...
    void freeObjMemory(void* pMem)
    {
        ...
        printf("Obj freeMemory: %llx, id=%d\n", pBlock, pBlock->nID);
    ...
    void* allocObjMemory(size_t nSize)
    {
        ...
        printf("Obj allocMemory: %llx, id=%d, size=%d\n", pReturn, pReturn->nID, (int)nSize);
...
private:
    //
    typedef CBaseObjectPool<Type, nPoolSzie> ClassTypePool;
    //
